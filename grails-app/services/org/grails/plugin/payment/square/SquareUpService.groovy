...
class SquareUpService {
    ...
    PaymentsApi getPaymentsApi() {
        //SquareClient squareClient = squareClient /// setInternalSquareClient()
    ...
    CreateCustomerResponse createCustomer(SquareClient client, CreateCustomerRequest body) throws ApiException, IOException {
